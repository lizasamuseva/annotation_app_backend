...
class FileManager:
    ...
    @staticmethod
    def create(content, filename, subdir="uploads"):
        """
    ...
    @staticmethod
    def save_cache(request, cache_key_description, entity_to_save):
        """
    ...
    @staticmethod
    def get_cache(request, cache_key_description):
        """
